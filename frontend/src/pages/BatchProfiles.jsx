                        ...
                        <div className="fs-batch-card__body">
                            ...
                            <div style={{ background: 'var(--cream2)', borderRadius: '8px', padding: '12px', marginTop: '8px', marginBottom: '12px' }}>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 800, fontSize: '0.85rem' }}>
                                    <div style={{ color: 'var(--red)' }}>N: {b.sensor_data?.soil?.est_n != null ? Number(b.sensor_data.soil.est_n).toFixed(2) : '--'}</div>                                    <div style={{ color: 'var(--gold)' }}>P: {b.sensor_data?.soil?.est_p != null ? Number(b.sensor_data.soil.est_p).toFixed(2) : '--'}</div>                                    <div style={{ color: 'var(--green)' }}>K: {b.sensor_data?.soil?.est_k != null ? Number(b.sensor_data.soil.est_k).toFixed(2) : '--'}</div>
                                </div>
                            </div>
                            <div
